...
var $author$project$Main$init = {count: 0, day: 0};
...
var $author$project$Main$Info = F2(
	function (day, count) {
		return {count: count, day: day};
	});
var $author$project$Main$alice = _List_fromArray(
	[
		A2($author$project$Main$Info, 1.0, 14),
		A2($author$project$Main$Info, 2, 14),
		A2($author$project$Main$Info, 3, 16),
		A2($author$project$Main$Info, 4, 16),
		A2($author$project$Main$Info, 5, 19),
		A2($author$project$Main$Info, 6, 19),
		A2($author$project$Main$Info, 7, 21),
		A2($author$project$Main$Info, 8, 24),
		A2($author$project$Main$Info, 9, 24),
		A2($author$project$Main$Info, 10, 24)
	]);
...
var $author$project$Main$chart = function (model) {
	return A3(
		...
		_List_fromArray(
			[
				A4($terezka$line_charts$LineChart$line, $terezka$line_charts$LineChart$Colors$red, $terezka$line_charts$LineChart$Dots$diamond, 'Alice', $author$project$Main$alice)
			]));
};
...
var $aforemny$material_components_web_elm$Material$List$clickHandler = function (listItems) {
	var getOnClick = function (listItem_) {
		switch (listItem_.$) {
			case 'ListItem':
				var config = listItem_.a.config;
				return $elm$core$Maybe$Just(config.onClick);
...
var $aforemny$material_components_web_elm$Material$List$nonInteractiveCs = function (_v0) {
	var nonInteractive = _v0.nonInteractive;
			...
			F2(
				function (index, listItem_) {
					switch (listItem_.$) {
						case 'ListItem':
							var config = listItem_.a.config;
							return (config.selected || config.activated) ? $elm$core$Maybe$Just(index) : $elm$core$Maybe$Nothing;
						case 'ListItemDivider':
							return $elm$core$Maybe$Nothing;
						default:
							return $elm$core$Maybe$Nothing;
				...
				A2(
					...
					_List_fromArray(
						[
							...
							$aforemny$material_components_web_elm$Material$List$nonInteractiveCs(config),
							$aforemny$material_components_web_elm$Material$List$denseCs(config),
							$aforemny$material_components_web_elm$Material$List$avatarListCs(config),
							$aforemny$material_components_web_elm$Material$List$twoLineCs(config),
							$aforemny$material_components_web_elm$Material$List$wrapFocusProp(config),
					...
					[
						...
						_List_fromArray(
							[
								...
								$aforemny$material_components_web_elm$Material$LayoutGrid$layoutGridCell,
								_List_fromArray(
									[$aforemny$material_components_web_elm$Material$LayoutGrid$span1]),
								_List_fromArray(
									[$author$project$Main$listSelector])),
								A2(
								$aforemny$material_components_web_elm$Material$LayoutGrid$layoutGridCell,
								_List_Nil,
								_List_fromArray(
								...
								A2($aforemny$material_components_web_elm$Material$LayoutGrid$layoutGridCell, _List_Nil, _List_Nil)
							]))
					]))
			]));
};
